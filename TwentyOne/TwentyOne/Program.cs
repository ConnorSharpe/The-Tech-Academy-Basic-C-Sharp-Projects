    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if(answer == "yes" || answer == "yeah" || answer == "y"|| answer == "yeah")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\conno\Logs\logs.txt", true))
                {
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            ...
            string queryString = "INSERT INTO Exceptions (ExceptionType, ExcpetionMessage, TimeStamp) VALUES " +
                "(@ExceptionType, @ExceptionMessage, @TimeStamp)";

            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand command = new SqlCommand(queryString, connection);
                command.Parameters.Add("@ExceptionType", SqlDbType.VarChar); //added varchar data type to inputs for this column
                command.Parameters.Add("@ExceptionMessage", SqlDbType.VarChar);
                command.Parameters.Add("@TimeStamp", SqlDbType.DateTime);

                //add value to parameters to specified collections
